package com.ez.weather4you.ui.navigation.bottomsheet

// FILE COPIED FROM https://github.com/android/nav3-recipes/blob/main/app/src/main/java/com/example/nav3recipes/bottomsheet/BottomSheetSceneStrategy.kt
 ...
 */
@OptIn(ExperimentalMaterial3Api::class)
class BottomSheetSceneStrategy<T : Any>(private val sheetState: SheetState) : SceneStrategy<T> {
